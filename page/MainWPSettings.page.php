                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="mainwp_maximumRequests"
                               id="mainwp_maximumRequests" value="<?php echo ((get_option('mainwp_maximumRequests') == false) ? 50 : get_option('mainwp_maximumRequests')); ?>"/> <i>Default: 50</i>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="mainwp_minimumDelay"
                               id="mainwp_minimumDelay" value="<?php echo ((get_option('mainwp_minimumDelay') == false) ? 100 : get_option('mainwp_minimumDelay')); ?>"/> <i>Default: 100</i>
                    </td>
                </tr>
                <tr>
                    <th colspan="2">&nbsp;</th>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="mainwp_maximumIPRequests"
                               id="mainwp_maximumIPRequests" value="<?php echo ((get_option('mainwp_maximumIPRequests') == false) ? 5 : get_option('mainwp_maximumIPRequests')); ?>"/> <i>Default: 5</i>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="mainwp_minimumIPDelay"
                               id="mainwp_minimumIPDelay" value="<?php echo ((get_option('mainwp_minimumIPDelay') == false) ? 300 : get_option('mainwp_minimumIPDelay')); ?>"/> <i>Default: 300</i>
                    </td>
                </tr>
            </tbody>
        </table>
