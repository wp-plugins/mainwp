...
/*
  ...
  Description: Manage all of your WP sites, even those on different servers, from one central dashboard that runs off from your own self-hosted WordPress install.
  Author: MainWP
