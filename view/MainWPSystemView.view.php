...
class MainWPSystemView
{
    public static function getMainWPTranslations()
    {
        ...
        mainwpAddTranslation($mainwpTranslations, 'No MainWP plugin detected, first install and activate the plugin and add your site to MainWP afterwards. Click <a href="%1" target="_blank">here</a> to install <a href="%2" target="_blank">MainWP</a> plugin (do not forget to activate it after installation).', __('No MainWP plugin detected, first install and activate the plugin and add your site to MainWP afterwards. Click <a href="%1" target="_blank">here</a> to install <a href="%2" target="_blank">MainWP</a> plugin (do not forget to activate it after installation).', 'mainwp'));
        ...
        mainwpAddTranslation($mainwpTranslations, 'Removing and deactivating the MainWP plugin..', __('Removing and deactivating the MainWP plugin..', 'mainwp'));
        mainwpAddTranslation($mainwpTranslations, 'The site has been removed and the MainWP plugin has been disabled', __('The site has been removed and the MainWP plugin has been disabled', 'mainwp'));
        ...
        mainwpAddTranslation($mainwpTranslations, 'The site has been removed but the MainWP plugin could not be disabled', __('The site has been removed but the MainWP plugin could not be disabled', 'mainwp'));
